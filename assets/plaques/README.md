...
Le script produit également `src/js/office-plaques-data.js`, qui embarque les mêmes PNG optimisés en palette de 128 couleurs. Le jeu utilise ces données pour éviter toute requête supplémentaire et toute contamination des textures WebGL en `file://`.
