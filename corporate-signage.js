...
(()=>{
  ...
  const sources={
    site:'signage/inetum-lcp7.png?v=1',
    mission:'signage/ordre-mission.png?v=1',
    swile:'signage/swile.png?v=1',
    purchase:'signage/bon-commande.png?v=1',
    concur:'signage/sap-concur.png?v=1',
    peopleDoc:'signage/mypeopledoc.png?v=1',
    chronotime:'signage/chronotime-2.png?v=1',
    support:'signage/global-service-center.png?v=1',
    success:'signage/success-factors.png?v=1',
    gcomp:'signage/gcomp.png?v=1',
    academy:'signage/learning-academy.png?v=1',
    powerUp:'signage/power-up.png?v=1',
    connect:'signage/lets-connect-france.png?v=1',
    genAi:'signage/gen-ai.png?v=1',
    charity:'signage/charity-day.png?v=1',
    summer:'signage/summer-party.png?v=1'
  };
  const images={};
