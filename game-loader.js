...
(()=>{
  ...
  // Bureau de Kévin : tableau plus compact pour dégager une vraie zone de plaque à droite.
 ...
 function julienOffice(mesh){const x=6.05,y=surface(1,x),z=-.72;mesh.box(x,y+.38,z,2.55,.12,1.0,'#6d5140');mesh.box(x-1.0,y-.02,z,.12,.8,.72,'#493a32');mesh.box(x+1.0,y-.02,z,.12,.8,.72,'#493a32');
   // Écran volontairement plus grand, plus clair et plus proche de la caméra.
   mesh.box(x+.48,y+.78,z+.48,1.12,.72,.12,'#203540');mesh.box(x+.48,y+.78,z+.55,.92,.52,.03,'#8ed0d7');mesh.box(x+.48,y+.46,z+.43,.10,.30,.10,'#344b58');mesh.box(x+.48,y+.31,z+.39,.50,.06,.30,'#344b58');mesh.box(x-.18,y+.45,z+.48,.72,.035,.32,'#d7caa8');
   // Tableau abaissé et légèrement moins haut : aucune collision visuelle avec le plafond.
   const wy=y+1.54,wz=-1.05;mesh.box(x,wy,wz,2.82,1.10,.07,'#f0f1eb');mesh.box(x,wy+.57,wz+.01,2.96,.055,.1,'#68757b');mesh.box(x,wy-.57,wz+.01,2.96,.055,.1,'#68757b');mesh.box(x-1.45,wy,wz+.01,.055,1.16,.1,'#68757b');mesh.box(x+1.45,wy,wz+.01,.055,1.16,.1,'#68757b');}
 `;
