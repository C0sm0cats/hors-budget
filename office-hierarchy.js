...
(()=>{
  ...
  function addBusinessOffice(mesh,sign,surface){
    ...
    const plaqueX=2.35,plaqueY=fy+1.82;mesh.box(plaqueX,plaqueY,-1.02,2.8,.66,.08,'#c6a052');card(sign,plaqueX,plaqueY,-.96,2.68,.57,(c,W,H)=>{c.fillStyle='#313844';c.fillRect(0,0,W,H);c.strokeStyle='#c6a052';c.lineWidth=7;c.strokeRect(4,4,W-8,H-8);c.fillStyle='#f2e7c7';c.font='900 '+H*.31+'px system-ui';c.textAlign='center';c.textBaseline='middle';c.fillText('CHACHA',W*.5,H*.52,W*.82);});
